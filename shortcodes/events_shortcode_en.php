<?php
 function nile_events_shortcode_en() { 
            ...
            ?>
                <div class="e-shortcode-col">
                    <div class="e-shortcode-item">
                        ...
                        <div>
                            <p><a href="<?php echo  get_the_permalink();?>" class="event-perma-link">Read More</i></a></p>
                        </div>
                    </div>
                </div>
            <?php 
 ...
 <?php } ?>
<?php 
    add_shortcode( 'nile_events_en', 'nile_events_shortcode_en' );
?>